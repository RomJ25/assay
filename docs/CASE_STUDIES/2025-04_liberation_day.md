...
**Sector rotation, not stock selection.** The investigation found sector-neutralized CB alpha of +0.1% — essentially zero. The screener's value comes from tilting toward cheap, quality sectors, not from picking the best stocks within those sectors. Liberation Day demonstrates both the power and the risk of that mechanism: the sector tilt toward Consumer Discretionary (35% of CB) put the portfolio directly in the path of tariff impacts. The offsetting tilt toward Health Care (19%) and Consumer Staples (12%) provided partial hedging. The screener did not pick BBY over some other Consumer Discretionary name because it was better; it picked BBY because its V and Q scores cleared the thresholds. That the sector tilt partially offset itself is diversification working as intended — not stock selection.

**No meaningful win/loss asymmetry.** The investigation found CB picks had a win/loss ratio of 1.05x at a 52% hit rate across 170 stock-quarter observations. Liberation Day is consistent: the CB portfolio did not exhibit asymmetric protection. It fell slightly less than SPY during the crash but lagged the recovery by more. The net result was slightly worse than SPY. There is no evidence of a structural edge in tail events — the screener is a disciplined filter, not a tail-risk hedge.
